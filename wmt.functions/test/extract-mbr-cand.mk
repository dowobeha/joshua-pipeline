...
$(if $6,,$(warning Function $0: an optional parameter $$6 (defining JOSHUA_EXTRACT_MBR_BEST_NUM_THREADS) was omitted. Assuming value of 1))

all: $1/$3

$1/$3.withOOV: $2 | $1
	java -cp $4/bin/joshua.jar -Dfile.encoding=utf8 \
		joshua.decoder.NbestMinRiskReranker $$< $$@ false 1 $(call JOSHUA_EXTRACT_MBR_THREADS,$6)
