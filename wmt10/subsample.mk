...
${SUBSAMPLER_TRAINING_DIR}/%.${SRC} ${SUBSAMPLER_TRAINING_DIR}/%.${TGT}: ${UNZIPPED_DATA}/%.${SRC} ${UNZIPPED_DATA}/%.${TGT} ${FILTER_SCRIPT} | ${SUBSAMPLER_TRAINING_DIR}
	${FILTER_SCRIPT} ${UNZIPPED_DATA}/$*.${SRC} ${UNZIPPED_DATA}/$*.${TGT} ${SUBSAMPLER_TRAINING_DIR}/$*.${SRC} ${SUBSAMPLER_TRAINING_DIR}/$*.${TGT} 
...
.PHONY: usage subsampler_training
