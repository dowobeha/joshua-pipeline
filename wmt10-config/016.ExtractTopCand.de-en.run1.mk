...
####                                                                        ####
#### This step extracts the 1-best top candidate translations
####                                                                        ####
################################################################################
...
####                                                                        ####
JOSHUA_EXTRACT_TOP_CAND_DIR:=${EXPERIMENT_DIR}/${THIS.MAKEFILE.NAME}
####                                                                        ####
################################################################################
...
####                                                                        ####
$(eval $(call import,${PATH.TO.THIS.MAKEFILE}/015.Translate.de-en.run1.mk))
####                                                                        ####
################################################################################
...
####                                                                        ####
export .DEFAULT_GOAL=joshua-extract-top-cand
####                                                                        ####
################################################################################
...
####                                                                        ####
$(eval $(call import,${EXPERIMENT_MAKE_DIR}/extract-top-cand.mk))
####                                                                        ####
################################################################################
