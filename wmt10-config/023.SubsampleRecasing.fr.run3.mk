...
export TGT:=truecase
export NORMALIZED_DATA:=${EXPERIMENT_DIR}/020.RecasingCorpus.fr
export FILES_TO_TRANSLATE:=em+internal2009.fr.lowercase
export SUBSAMPLER_MANIFEST:=news-commentary10.fr-en.fr europarl-v5.fr-en.fr giga-fren.release2.fr undoc.2000.en-fr.fr
