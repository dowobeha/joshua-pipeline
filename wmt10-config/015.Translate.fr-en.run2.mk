...
export JOSHUA_RULES_DIR:=${EXPERIMENT_DIR}/012.ExtractGrammarHiero.fr-en.run2
export JOSHUA_TRANSLATION_INPUT_DIR:=${EXPERIMENT_DIR}/008.NormalizedData
export JOSHUA_TRANSLATION_INPUT:=newstest2009-src.fr
export JOSHUA_TRANSLATION_OUTPUT:=newstest2009.en
####                                                                        ####
################################################################################
