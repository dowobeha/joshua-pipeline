...
export TGT:=truecase
export NORMALIZED_DATA:=${EXPERIMENT_DIR}/020.RecasingCorpus.de
export FILES_TO_TRANSLATE:=em+internal2009.de.lowercase
export SUBSAMPLER_MANIFEST:=news-commentary10.de-en.de europarl-v5.de-en.de
