...
export JOSHUA_RULES_DIR:=${EXPERIMENT_DIR}/012.ExtractGrammarHiero.fr-en.run3
export JOSHUA_TRANSLATION_INPUT_DIR:=${EXPERIMENT_DIR}/008.NormalizedData
export JOSHUA_TRANSLATION_INPUT:=em+internal2009.fr
...
####                                                                        ####
$(eval $(call import,${PATH.TO.THIS.MAKEFILE}/014.MERT.fr-en.bleu.run1.mk))
####                                                                        ####
################################################################################
