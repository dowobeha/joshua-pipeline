...
export JOSHUA_RULES_DIR:=${EXPERIMENT_DIR}/012.ExtractGrammarHiero.en-fr.run3
export JOSHUA_TRANSLATION_INPUT_DIR:=${EXPERIMENT_DIR}/008.NormalizedData
export JOSHUA_TRANSLATION_INPUT:=em+internal2009.en
export JOSHUA_TRANSLATION_OUTPUT:=em+internal2009.fr
####                                                                        ####
################################################################################
...
####                                                                        ####
$(eval $(call import,${PATH.TO.THIS.MAKEFILE}/014.MERT.en-fr.bleu.run1.mk))
####                                                                        ####
################################################################################
