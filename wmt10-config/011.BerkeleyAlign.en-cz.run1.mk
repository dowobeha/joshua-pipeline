...
####                                                                        ####
export BERKELEY_NUM_THREADS:=4
export BERKELEY_JVM_FLAGS:=-d64 -Dfile.encoding=utf8 -XX:MinHeapFreeRatio=10 -Xms7g -Xmx7g
...
$(eval $(call import,${PATH.TO.THIS.MAKEFILE}/010.Subsample.en-cz.run1.mk))
####                                                                        ####
################################################################################
