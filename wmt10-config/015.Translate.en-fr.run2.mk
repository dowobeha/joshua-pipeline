...
export JOSHUA_RULES_DIR:=${EXPERIMENT_DIR}/012.ExtractGrammarHiero.en-fr.run2
export JOSHUA_TRANSLATION_INPUT_DIR:=${EXPERIMENT_DIR}/008.NormalizedData
export JOSHUA_TRANSLATION_INPUT:=newstest2009-src.en
export JOSHUA_TRANSLATION_OUTPUT:=newstest2009.fr
####                                                                        ####
################################################################################
