...
####                                                                        ####
#### This step constructs a parallel corpus for re-casing
####                                                                        ####
################################################################################
...
####                                                                        ####
export RECASING_CORPUS_DIR:=${EXPERIMENT_DIR}/${THIS.MAKEFILE.NAME}
####                                                                        ####
################################################################################
...
####                                                                        ####
$(eval $(call import,${PATH.TO.THIS.MAKEFILE}/010.Subsample.fr-en.run3.mk))
####                                                                        ####
################################################################################
...
####                                                                        ####
export .DEFAULT_GOAL=recasing-corpus
####                                                                        ####
################################################################################
...
####                                                                        ####
$(eval $(call import,${EXPERIMENT_MAKE_DIR}/create-recasing-corpus.mk))
####                                                                        ####
################################################################################
