...
export TGT:=truecase
export NORMALIZED_DATA:=${EXPERIMENT_DIR}/020.RecasingCorpus.en
export FILES_TO_TRANSLATE:=em+internal2009.en.lowercase
export SUBSAMPLER_MANIFEST:=news-commentary10.fr-en.en europarl-v5.fr-en.en giga-fren.release2.en undoc.2000.en-fr.en
